...
//    
//    private static final byte[] DEFAULT_FILE = new byte[] {1, 6, 3};
//    private static final byte[] UPDATED_FILE = new byte[] {1, 6, 4};
//
//    @Inject
...
//        assertThat(testAbsensi.getFile()).isEqualTo(DEFAULT_FILE);
