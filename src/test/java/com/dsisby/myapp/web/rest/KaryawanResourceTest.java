...
public class KaryawanResourceTest {
    ...
    private static final String DEFAULT_STATUS_KERJA = "SAMPLE_TEXT";
    private static final String UPDATED_STATUS_KERJA = "UPDATED_TEXT";
    private static final LocalDate DEFAULT_TANGGAL_RESIGN = new LocalDate(0L);
    private static final LocalDate UPDATED_TANGGAL_RESIGN = new LocalDate();
    ...
    public void initTest() {
        ...
        karyawan.setStatusKerja(DEFAULT_STATUS_KERJA);
        karyawan.setTanggalResign(DEFAULT_TANGGAL_RESIGN);
    }
    ...
    public void createKaryawan() throws Exception {
        ...
        assertThat(testKaryawan.getStatusKerja()).isEqualTo(DEFAULT_STATUS_KERJA);
        assertThat(testKaryawan.getTanggalResign()).isEqualTo(DEFAULT_TANGGAL_RESIGN);
    }
    ...
    public void getAllKaryawans() throws Exception {
        ...
        restKaryawanMockMvc.perform(get("/api/karyawans"))
                ...
                .andExpect(jsonPath("$.[0].statusKerja").value(DEFAULT_STATUS_KERJA))
                .andExpect(jsonPath("$.[0].tanggalResign").value(DEFAULT_TANGGAL_RESIGN.toString()));
    }
    ...
    public void getKaryawan() throws Exception {
        ...
        restKaryawanMockMvc.perform(get("/api/karyawans/{id}", karyawan.getId()))
            ...
            .andExpect(jsonPath("$.statusKerja").value(DEFAULT_STATUS_KERJA))
            .andExpect(jsonPath("$.tanggalResign").value(DEFAULT_TANGGAL_RESIGN.toString()));
    }
    ...
    public void updateKaryawan() throws Exception {
        ...
        karyawan.setStatusKerja(UPDATED_STATUS_KERJA);
        karyawan.setTanggalResign(UPDATED_TANGGAL_RESIGN);
        restKaryawanMockMvc.perform(post("/api/karyawans")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(karyawan)))
                .andExpect(status().isOk());
        ...
        assertThat(testKaryawan.getStatusKerja()).isEqualTo(UPDATED_STATUS_KERJA);
        assertThat(testKaryawan.getTanggalResign()).isEqualTo(UPDATED_TANGGAL_RESIGN);
    }
